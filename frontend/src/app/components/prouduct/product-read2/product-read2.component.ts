...
//esse componente foi refatorado para listar Product 
...
export class ProductRead2Component implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    //atribui o dataSource da tabela, da para fazer no próprio elemento
    //HTML usando proprerie bingind "[dataSource]="dataSource.data"
